    ...
    function monthSelectPlugin(pluginConfig) {
        ...
        return function (fp) {
            ...
            function build() {
                ...
                self.monthsContainer.setAttribute("aria-label", fp.l10n.monthsAriaLabel || "Months");
                buildMonths();
            ...
            function buildMonths() {
                ...
                for (var i = 0; i < 12; i++) {
                    ...
                    month.setAttribute("aria-label", "Select " + monthToStr(i, false, fp.l10n) + " " + fp.currentYear);
