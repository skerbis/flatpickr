...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.pickit = factory());
    ...
    function FlatpickrInstance(element, instanceConfig) {
        ...
        function setHours(hours, minutes, seconds) {
            ...
            if (!self.hourElement || !self.minuteElement || self.isMobile)
                return;
            var displayHours = !self.config.time_24hr
        ...
        function build() {
            ...
            self.liveRegion = createElement("div", "flatpickr-sr-only");
        ...
        function updateWeekdays() {
            ...
            var weekdaysShort = __spreadArrays(self.l10n.weekdays.shorthand);
            var weekdaysLong = __spreadArrays(self.l10n.weekdays.longhand);
            if (firstDayOfWeek > 0 && firstDayOfWeek < weekdaysShort.length) {
                weekdaysShort = __spreadArrays(weekdaysShort.splice(firstDayOfWeek, weekdaysShort.length), weekdaysShort.splice(0, firstDayOfWeek));
                weekdaysLong = __spreadArrays(weekdaysLong.splice(firstDayOfWeek, weekdaysLong.length), weekdaysLong.splice(0, firstDayOfWeek));
            }
            for (var i = self.config.showMonths; i--;) {
                var weekdayElements = weekdaysShort
                    .map(function (day, idx) {
                    return "<abbr class='flatpickr-weekday' title='" + weekdaysLong[idx] + "' aria-label='" + weekdaysLong[idx] + "'>" + day + "</abbr>";
                })
                    .join("");
        ...
        function changeMonth(value, isOffset) {
            ...
            announceToScreenReader(self.l10n.months.longhand[self.currentMonth] + " " + self.currentYear);
        }
        ...
        function onKeyDown(e) {
            ...
            if ((e.keyCode === 13 || e.keyCode === 32) &&
                self.prevMonthNav &&
                self.nextMonthNav &&
                (self.prevMonthNav.contains(eventTarget) ||
                    self.nextMonthNav.contains(eventTarget))) {
                e.preventDefault();
                ...
                switch (e.keyCode) {
                    ...
                    case 33:
                        if (!isTimeObj && !isInput && self.daysContainer) {
                            ...
                            if (e.shiftKey) {
                                ...
                                announceToScreenReader(self.l10n.months.longhand[self.currentMonth] + " " + (self.currentYear - 1));
                            }
                            else {
                                changeMonth(-1);
                                announceToScreenReader(self.l10n.months.longhand[self.currentMonth] + " " + self.currentYear);
                    ...
                    case 84:
                        if (!isTimeObj &&
                            ...
                            focusOnDay(self.todayDateElem, 0);
                            announceToScreenReader((self.l10n.todayAriaLabel || "Today") + ": " + self.formatDate(self.now, self.config.ariaDateFormat));
                        }
                        break;
                    case 37:
                    case 39:
                    ...
                    case 9:
                        if (isTimeObj) {
                            ...
                            var focusableElements = calendarElements.filter(function (x) { return x; });
                            ...
                            if (currentIndex !== -1) {
                                ...
                                e.preventDefault();
                                var daysIndex = focusableElements.indexOf(self.daysContainer);
                                if (daysIndex > 0) {
        ...
        function open(e, positionElement) {
            ...
            if (!wasOpen) {
                ...
                announceToScreenReader((self.l10n.datePickerAriaLabel || "Date picker") + " " + self.l10n.months.longhand[self.currentMonth] + " " + self.currentYear);
            }
        ...
        function selectDate(e) {
            ...
            if (self.config.mode === "single") {
                announceToScreenReader(self.formatDate(selectedDate, self.config.ariaDateFormat) + " " + (self.l10n.datePickerAriaLabel || "selected"));
            }
            else if (self.config.mode === "range") {
                if (self.selectedDates.length === 1) {
                    announceToScreenReader((self.l10n.rangeStartAriaLabel || "Range start") + ": " + self.formatDate(selectedDate, self.config.ariaDateFormat));
                }
                else if (self.selectedDates.length === 2) {
                    announceToScreenReader((self.l10n.rangeEndAriaLabel || "Range end") + ": " + self.formatDate(selectedDate, self.config.ariaDateFormat));
                }
            }
            // maintain focus
            if (!shouldChangeMonth &&
